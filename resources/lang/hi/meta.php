...
return [
    ...
    'iptv-applications' => [
        ...
        'description' => 'IPTV ऐप्स डाउनलोड करें जिनमें iptv smart player और Smarters Pro शामिल हैं। xtreme hd iptv, Android, iOS और 4K डिवाइस के साथ कम्पैटिबल। बेस्ट iptv अनुभव।',
        'keywords' => 'iptv smart player, iptv Smarters, xtreme hd iptv, iptv box, best iptv, aroma iptv, 4k live iptv',
    ],
    'faqs' => [
        'title' => 'Opplex IPTV FAQs | सेटअप, सपोर्ट और मुफ्त ट्रायल सहायता',
        'description' => 'xtreme hd iptv, iptv smart player सेटअप, 4K स्ट्रीमिंग और iptv free trial के बारे में जवाब पाएं। USA, UK, France, Italy के लिए फुल सपोर्ट।',
        'keywords' => 'iptv support, iptv setup, xtreme hd iptv, iptv smart player, aroma iptv, best iptv, 4k live iptv',
    ],
    'contact' => [
        'title' => 'Opplex IPTV से संपर्क करें | मुफ्त ट्रायल और सपोर्ट',
        'description' => 'Best iptv सेटअप में मदद चाहिए? Opplex से संपर्क करें मुफ्त ट्रायल, रिसेलर जानकारी, xtreme hd iptv, 4K स्ट्रीमिंग और iptv smart player सपोर्ट के लिए।',
    ...
    'terms-of-service' => [
        'title'       => 'सेवा की शर्तें और वैध उपयोग नीति',
        'description' => 'Opplex IPTV की सेवा शर्तें पढ़ें। खाता नियम, उचित उपयोग, भुगतान, नवीनीकरण और सेवा उपलब्धता के बारे में जानें।',
        'keywords'    => 'Opplex IPTV शर्तें, IPTV नियम, भुगतान IPTV, नवीनीकरण, वैध IPTV नीति',
    ],
    'privacy-policy' => [
        'title'       => 'गोपनीयता नीति और डेटा सुरक्षा',
        'description' => 'हमारी गोपनीयता नीति बताती है कि हम कौन-सा डेटा एकत्र करते हैं, कुकीज़ का उपयोग कैसे करते हैं और आपकी जानकारी की सुरक्षा कैसे करते हैं।',
        'keywords'    => 'गोपनीयता IPTV, Opplex IPTV, डेटा सुरक्षा, कुकीज़, व्यक्तिगत जानकारी, IPTV सुरक्षा',
    ],
    'refund-policy' => [
        'title'       => 'अंतिम बिक्री और रिफंड नीति',
        'description' => 'Opplex IPTV सदस्यताओं की अंतिम बिक्री की शर्तें, रद्दीकरण और लागू कानून द्वारा आवश्यक रिफंड की जानकारी पढ़ें।',
        'keywords'    => 'IPTV अंतिम बिक्री, रिफंड नीति, गैर-वापसी योग्य खरीदारी, IPTV रद्दीकरण',
    ],
    'shop' => [
    ...
    'blogs' => [
        'index' => [
            'title' => 'ब्लॉग | Opplex IPTV समाचार और गाइड',
            'description' => 'Opplex IPTV से IPTV टिप्स, सेटअप गाइड और नवीनतम अपडेट पढ़ें। ऐप्स, डिवाइस, स्ट्रीमिंग क्वालिटी और IPTV के कानूनी उपयोग के बारे में जानें।',
            'keywords' => 'IPTV ब्लॉग, IPTV गाइड, IPTV टिप्स, Opplex IPTV समाचार, स्ट्रीमिंग अपडेट, IPTV सेटअप',
        ],
        'show' => [
            'title' => 'ब्लॉग पोस्ट | Opplex IPTV',
            'description' => 'Opplex IPTV से नवीनतम IPTV लेख पढ़ें। बेहतर स्ट्रीमिंग के लिए टिप्स, गाइड और अपडेट।',
            'keywords' => 'IPTV ब्लॉग पोस्ट, IPTV लेख, Opplex IPTV, IPTV टिप्स, स्ट्रीमिंग गाइड',
        ],
    ],
];
