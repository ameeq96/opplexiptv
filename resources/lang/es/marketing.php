...
return [
    'event_promotion' => [
        'whatsapp_click_message' => 'Hola, quiero usar la oferta del 10 % de :event en mi pedido de Opplex IPTV. La oferta es válida hasta el :date.',
        'events' => [
            'new-year' => 'Año Nuevo',
    ...
    'social_proof' => [
        'verified_purchase' => 'Compra de un cliente',
