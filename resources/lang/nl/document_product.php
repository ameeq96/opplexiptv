...
return [
    'applications' => [
        ...
        'platforms' => [
            'android' => [
                'eyebrow' => 'Voor Android-apparaten',
                'heading' => 'Beste IPTV-apps voor Android',
                'intro' => 'Deze apps werken op Android-telefoons, tablets, Fire TV Stick, Android TV-boxen en MAG-apparaten. IPTV Smarters Pro is de populairste keuze. De Opplex- en XTV-apps zijn onze eigen lichtere versies en zijn speciaal voor ons platform gebouwd.',
            ],
            'ios' => [
                'eyebrow' => 'Voor iOS-apparaten',
                'heading' => 'Beste IPTV-apps voor iPhone en iPad',
                'intro' => 'iPhone- en iPad-gebruikers hebben hieronder een paar goede opties. Smarters Player Lite is het makkelijkste startpunt; de app is gratis in de App Store en ondersteunt inloggen met Xtream Codes.',
            ],
            'windows' => [
                'eyebrow' => 'Voor Windows-apparaten',
                'heading' => 'IPTV-apps voor Windows-PC en -laptop',
                'intro' => 'Beide onderstaande opties werken op Windows 10 en hoger. IPTV Smarters Pro voor Windows biedt dezelfde vertrouwde interface als de Android-versie, maar dan op een groter scherm.',
            ],
            'macos' => [
                'eyebrow' => 'Voor macOS-apparaten',
                'heading' => 'IPTV-app voor Mac',
                'intro' => 'Mac-gebruikers kunnen IBO Player gebruiken om Opplex op hun MacBook of iMac te streamen. Macs met Intel-processor worden volledig ondersteund.',
            ],
            'linux' => [
                'eyebrow' => 'Voor Linux-apparaten',
                'heading' => 'IPTV-app voor Linux',
                'intro' => 'Gebruik je Ubuntu of Debian? IBO Player heeft een Linux-versie die met je Opplex-abonnement werkt.',
            ],
        ],
        'app_descriptions' => [
            'smarters_android' => 'De meest gebruikte IPTV-speler op Android. Overzichtelijke interface, ondersteuning voor inloggen met Xtream Codes, EPG-gids en betrouwbare weergave. Werkt perfect met je Opplex-abonnement.',
        ...
        'faq' => [
            ...
            'items' => [
                [
                    'question' => 'Welke app moet ik gebruiken met Opplex IPTV?',
                    'answer' => 'Voor de meeste mensen is IPTV Smarters Pro het makkelijkste startpunt, omdat deze beschikbaar is op Android, iOS en Windows. Wil je liever iets lichters, probeer dan de Opplex- of XTV-app. Weet je het niet zeker? Vertel ons via WhatsApp welk apparaat je hebt en wij zeggen precies wat je moet downloaden.',
                ],
                [
                    'question' => 'Hoe installeer ik de app op mijn apparaat?',
                    'answer' => 'Download op deze pagina de app voor je platform. Tik op Android op het APK-bestand om het te installeren. Mogelijk moet je in de instellingen van je telefoon installaties uit onbekende bronnen toestaan. Op iOS word je naar de App Store geleid. Voer op Windows het .exe-installatieprogramma uit. Het duurt minder dan twee minuten.',
                ],
                [
                    'question' => 'Waar voer ik mijn inloggegevens in?',
                    'answer' => 'Open de app en zoek naar de optie \'Login with Xtream Codes\' (soms aangeduid als \'Username / Password\'). Voer de server-URL, gebruikersnaam en het wachtwoord uit je activeringsmail of WhatsApp-bericht in. Daarna worden je kanalen automatisch geladen.',
                ],
                [
                ...
                [
                    ...
                    'answer' => 'Ja, elke app op deze pagina is gratis. Je betaalt alleen voor je Opplex IPTV-abonnement, dat je toegang geeft tot de kanalen en content.',
                ],
            ],
        ],
        'cta' => [
    ...
    'movies' => [
        ...
        'library' => [
            'heading' => 'Wat staat er in de bibliotheek?',
            'items' => [
                [
                    'title' => 'Films — Hollywood, Bollywood en verder',
                    'text' => 'De filmsectie omvat alle belangrijke genres: actie, thriller, drama, komedie, horror, sciencefiction, romantiek en documentaires. Hollywood-blockbusters staan naast Bollywood-releases, Europese cinema en internationale titels. Nieuwe releases worden regelmatig toegevoegd; je hoeft niet steeds dezelfde tien films opnieuw te bekijken.',
                ],
                [
                ...
                [
                    ...
                    'text' => 'Een speciale cartoonsectie biedt geanimeerde content voor kinderen en gezinnen. Heb je kinderen thuis, dan krijgt het hele gezin met één Opplex-abonnement wat het wil.',
                ],
            ],
        ],
        'how_to_watch' => [
            'heading' => 'Films zoeken en bekijken op Opplex',
            'intro' => 'VOD is in elk abonnement ingebouwd; je hoeft niets extra\'s te activeren. Zodra je bij je IPTV-app bent aangemeld:',
            'steps' => [
                'Open op het startscherm van de app het tabblad Films, Series of Tekenfilms',
                'Blader op genre of gebruik de zoekbalk om een titel op naam te vinden',
                'Tik om af te spelen — content wordt binnen enkele seconden geladen',
                'Pauzeer, spoel terug en vooruit, net als bij elke gewone streamingapp',
            ],
            'devices' => 'Het werkt op dezelfde manier op Firestick, Smart TV, Android TV-box, Android- en iOS-telefoons, MAG-apparaten en Windows of Mac via elke ondersteunde IPTV-speler.',
        ...
        'devices' => [
            ...
            'items' => [
                ...
                'Android TV-boxen en MAG-apparaten',
                'Android- en iOS-telefoons en -tablets',
                'Windows-PCs en -laptops',
                'Mac via IBO Player',
            ],
            'quality' => 'De beeldkwaliteit past zich aan je verbinding aan. De meeste titels streamen in Full HD. 4K is beschikbaar voor ondersteunde content wanneer je verbinding minimaal 25 Mbps is.',
            'apps' => 'Bekijk alle compatibele apps',
            'plans' => 'Bekijk abonnementen',
        ],
        'faq' => [
            'heading' => 'Films en series — Veelgestelde vragen',
            'items' => [
                [
                    'question' => 'Wat is het verschil tussen de tabbladen Films, Series en Tekenfilms?',
                    'answer' => 'Films bevat afzonderlijke films. Series bevat programma\'s met meerdere afleveringen, zowel lopend als afgerond. Tekenfilms is een afzonderlijke sectie met geanimeerde content voor kinderen en gezinnen. Het tabblad Alles toont alles samen. Je kunt ook de zoekbalk gebruiken om de categorieën helemaal over te slaan.',
                ],
                [
                ...
                [
                    ...
                    'answer' => 'Nee, Opplex is een streamingdienst, geen downloaddienst. Je hebt een actieve internetverbinding nodig om te kijken. We adviseren minimaal 15 Mbps voor HD en 25 Mbps voor 4K.',
                ],
                [
                    'question' => 'Waarom stopt of buffert een film soms halverwege?',
                    'answer' => 'Dit komt vrijwel altijd door een verbindingsprobleem of tijdelijk veel verkeer op die server. Pauzeer 10 tot 15 seconden en ga dan verder; meestal is het probleem daarmee opgelost. Blijft dit bij een specifieke titel gebeuren, laat het ons dan weten via WhatsApp en wij controleren de bron.',
                ],
                [
                    'question' => 'Kan ik een titel aanvragen die niet in de bibliotheek staat?',
                    'answer' => 'Ja. Stuur ons via WhatsApp de naam van de film of serie. Wij controleren de beschikbaarheid en voegen deze toe waar dat mogelijk is. De meeste verzoeken worden binnen een dag of twee afgehandeld.',
                ],
                [
                    'question' => 'Is de content van dezelfde kwaliteit als Netflix of Prime Video?',
                    'answer' => 'De bronkwaliteit verschilt per titel, net als bij elke streamingdienst. Veel titels zijn in Full HD of 4K. Sommige oudere content is in SD. Is de beeldkwaliteit voor een bepaalde film belangrijk, stuur ons dan eerst een bericht en wij bevestigen wat beschikbaar is.',
                ],
                [
    ...
    'subscription' => [
        ...
        'hero' => [
            ...
            'primary_cta' => 'Stel je IPTV-abonnement samen',
        ...
        'included' => [
            'heading' => 'Alles in je Opplex-abonnement',
            'intro' => 'Geen niveaus. Geen vergrendelde functies. Dit omvat elk abonnement vanaf de eerste dag:',
            'items' => [
                '12,000+ livekanalen | UK, USA, sport, internationaal, nieuws, kinderen',
                '50,000+ films on demand',
                '5,000+ TV-series, huidige seizoenen en klassiekers',
                'HD- en 4K-kwaliteit op ondersteunde content',
                'Ingebouwde EPG, zodat je ziet wat er nu en straks te zien is',
                'Catch-up-TV op geselecteerde kanalen',
                'Werkt op Firestick, Smart TV, Android, iOS, MAG, Windows en Mac',
                'Ondersteuning voor meerdere IPTV-spelerapps',
                '24/7 ondersteuning via WhatsApp en e-mail',
                'Gratis proefperiode beschikbaar voordat je je vastlegt',
            ],
        ],
        'devices' => [
            'heading' => 'Werkt op de apparaten die je al hebt',
            'intro' => 'Je hoeft niets te kopen om Opplex te gebruiken. Het werkt op:',
            'items' => [
                'Amazon Firestick (alle generaties) en Fire TV',
                'Samsung, LG en Sony Smart TV\'s',
                'Android TV-boxen en MAG-apparaten',
                'Android-telefoons en -tablets',
                'iPhone en iPad',
                'Windows-PC en -laptop',
                'Mac via IBO Player',
            ],
            'text' => 'De apps zijn gratis te downloaden. Je betaalt alleen voor het abonnement. Weet je niet welke app geschikt is voor je apparaat, bekijk dan de pagina Applicaties of stuur ons rechtstreeks een bericht.',
            'cta' => 'Bekijk alle IPTV-apps',
        ],
        'comparison' => [
    ...
    'shop' => [
        'page_title' => 'Winkel',
        'hero' => [
            'eyebrow' => 'Alles wat je nodig hebt om te installeren en te streamen',
            'heading' => 'Streamingapparaten, accessoires en digitale abonnementen | Alles op één plek',
            'text' => 'De Opplex-winkel heeft twee soorten producten: hardware die IPTV-streaming beter maakt en digitale abonnementen tegen prijzen die je niet in de gewone winkel vindt. Affiliate-apparaten linken rechtstreeks naar Amazon. Digitale producten zoals Netflix, Prime Video, HBO Max en NordVPN zijn beschikbaar tegen scherpe tarieven. Tik op Nu kopen en voltooi je bestelling via WhatsApp.',
            'note' => 'Heb je al een apparaat en heb je alleen Opplex nodig? Ga dan naar de pagina Packages.',
            'devices' => 'Bekijk apparaten',
            'digital' => 'Bekijk digitale producten',
            'plans' => 'Bekijk IPTV-abonnementen',
        ],
        'section_headings' => [
            'devices' => 'Streamingapparaten en accessoires',
            'devices_intro' => 'Affiliate-apparaten linken rechtstreeks naar Amazon, waar aankoop, levering, retouren en terugbetalingen worden afgehandeld.',
            'digital' => 'Digitale abonnementen',
            'digital_intro' => 'Kies een digitaal abonnement en tik op Nu kopen om je bestelling bij ons via WhatsApp af te ronden.',
        ],
        'product_descriptions' => [
            'affiliate' => [
                'B08CRV62C4' => ['label' => 'Android TV Box (4GB RAM, 32GB ROM, 6K, Wi-Fi 5.0, Bluetooth 5.0)', 'text' => 'Een veelzijdig apparaat waarop elke belangrijke IPTV-app direct werkt. De quad-coreprocessor zorgt voor soepele weergave en de dual-band Wi-Fi verwerkt 4K zonder bekabelde verbinding. Een goede keuze als je een speciaal apparaat wilt dat achter de tv blijft staan.'],
                'B0BP9SNVH9' => ['label' => 'Amazon Fire TV Stick 4K Max (Wi-Fi 6E)', 'text' => 'Het populairste apparaat onder Opplex-gebruikers. Sluit het aan op een willekeurige HDMI-poort, download de IPTV-app van je keuze en je kijkt binnen enkele minuten. Wi-Fi 6E-ondersteuning betekent een lagere latentie, zelfs op een druk thuisnetwerk. Een goede upgrade als je nog een oudere Firestick gebruikt.'],
                'B0DXXYS4BJ' => ['label' => 'Roku Streaming Stick HD 2025', 'text' => 'Overzichtelijk en eenvoudig streamen met een spraakafstandsbediening. Een goede optie als je de voorkeur geeft aan een vertrouwde tv-interface. Let op: Roku heeft een gesloten appwinkel, dus controleer vóór aankoop de appcompatibiliteit als je een IPTV-speler van derden wilt gebruiken.'],
        ...
        'guide' => [
            'heading' => 'Weet je niet welk apparaat je moet nemen? Hier is een korte gids',
            'items' => [
                ['title' => 'Je hebt een gewone TV met een HDMI-poort', 'text' => 'Neem de Firestick 4K Max. Deze sluit je rechtstreeks aan, draait de Opplex-app of IPTV Smarters Pro en verandert elke TV in een slim streamingscherm. De meeste van onze gebruikers beginnen hiermee.'],
                ['title' => 'Je wilt een volledige Android-box met meer opslag en controle', 'text' => 'De Android TV Box is dan de betere keuze. Meer RAM, meer opslag en je kunt elke app rechtstreeks installeren zonder via een gesloten winkel te gaan.'],
                ['title' => 'Je hebt al een Smart TV (Samsung, LG, Sony)', 'text' => 'Waarschijnlijk heb je geen nieuw apparaat nodig. Download rechtstreeks uit de appwinkel van je tv een IPTV-spelerapp of sideload deze als je tv dat ondersteunt. Bekijk op de pagina Applicaties welke spelers het beste werken.'],
                ['title' => 'Je gebruikt een PC of Mac', 'text' => 'Download IPTV Smarters Pro voor Windows of IBO Player voor Mac. Beide zijn gratis en werken met de login van je Opplex-abonnement. Geen extra hardware nodig.'],
                ['title' => 'Je wilt je opstelling netjes maken', 'text' => 'De Mounting Dream-wandbeugel zorgt voor een nette installatie en laat je na de eerste montage de kijkhoek zonder gereedschap aanpassen. Geschikt voor de meeste tv\'s van 32 tot 65 inch.'],
            ],
            'support' => 'Nog steeds niet zeker? Stuur ons via WhatsApp je TV-model en wat je wilt doen; wij vertellen je precies wat je nodig hebt.',
        ],
        'digital_orders' => [
            'heading' => 'Hoe bestellingen van digitale producten werken',
            'intro' => 'Digitale abonnementen zoals Netflix, Prime Video, HBO Max en NordVPN lopen niet via de standaardbetaling. Zo bestel je:',
            'steps' => [
