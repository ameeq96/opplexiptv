...
return [
    'applications' => [
        ...
        'hero' => [
            ...
            'support' => "Not sure which app to use? Message us on WhatsApp, and we'll point you to the right one for your device.",
        ],
        'platforms' => [
            'android' => [
            ...
            'ios' => [
                ...
                'heading' => 'Best IPTV Apps for iPhone & iPad',
                'intro' => "iPhone and iPad users have a few solid options below. Smarters Player Lite is the easiest starting point; it's free on the App Store and supports Xtream Codes login.",
            ],
            'windows' => [
                'eyebrow' => 'For Windows Devices',
                'heading' => 'IPTV Apps for Windows PC & Laptop',
                'intro' => 'Both options below work on Windows 10 and above. IPTV Smarters Pro for Windows gives you the same familiar interface as the Android version, just on a bigger screen.',
            ],
            'macos' => [
                'eyebrow' => 'For macOS Devices',
                'heading' => 'IPTV App for Mac',
                'intro' => 'Mac users can use IBO Player to stream Opplex on their MacBook or iMac. Intel-based Macs are fully supported.',
            ],
            'linux' => [
                'eyebrow' => 'For Linux Devices',
                'heading' => 'IPTV App for Linux',
                'intro' => 'Running Ubuntu or Debian? IBO Player has a Linux build that works with your Opplex subscription.',
            ],
        ],
        'app_descriptions' => [
            'smarters_android' => 'The most widely used IPTV player on Android. Clean interface, Xtream Codes login support, EPG guide, and reliable playback. Works perfectly with your Opplex subscription.',
            'opplex' => 'Our own app, built and maintained by us. Lighter than Smarters, faster to load, and optimised for Opplex streams. A solid choice if you want a clean, no-fuss experience.',
            'xtv' => 'Another Opplex-built player. Great for Android boxes and Fire TV Stick users who prefer a TV-style interface with big buttons and easy navigation.',
            'xtream_android' => 'A good backup option. Supports Xtream Codes and M3U playlists. Available on both Android and iOS.',
            'ibo_android' => 'Works across Android, Windows, and Mac. A solid choice if you switch between devices and want one app everywhere.',
            'star_share' => "An alternative Android player compatible with Opplex login codes. Good option if Smarters isn't working on your specific device.",
            'smarters_ios' => 'The iOS version of the popular Smarters player. Free download from the App Store. Sign in with your Opplex Xtream Codes, and your channels load automatically.',
            'player_000' => 'A clean, minimal IPTV player for iPhone. Good picture quality and simple to navigate.',
            'xtream_ios' => 'The iOS version of 9Xtream. Works with your Opplex login and supports both live channels and VOD.',
            'smarters_windows' => 'Full-featured IPTV player for Windows. Same Xtream Codes login as the Android version. Works well on laptops and desktop monitors.',
            'ibo_windows' => 'A cross-platform option for Windows 10 and above. Good if you also use IBO on Android or Mac and want the same app everywhere.',
        ...
        'faq' => [
            ...
            'items' => [
                [
                    'question' => 'Which app should I use with Opplex IPTV?',
                    'answer' => "For most people, IPTV Smarters Pro is the easiest starting point, as it's available on Android, iOS, and Windows. If you prefer something lighter, try the Opplex or XTV app. Not sure? Just tell us your device on WhatsApp, and we'll tell you exactly what to download.",
                ],
                [
                    'question' => 'How do I install the app on my device?',
                    'answer' => "Download the app for your platform from this page. On Android, tap the APK file to install. You may need to allow installs from unknown sources in your phone's settings. On iOS, it takes you to the App Store. On Windows, run the .exe installer. It takes under two minutes.",
                ],
                [
                    'question' => 'Where do I enter my login details?',
                    'answer' => "Open the app and look for the 'Login with Xtream Codes' option (sometimes labelled 'Username / Password'). Enter the server URL, username, and password from your activation email or WhatsApp message. Your channels will load automatically after that.",
                ],
                [
                    'question' => "The app loaded, but my channels won't play. What do I do?",
                    'answer' => "First, check your internet connection. We recommend at least 15 Mbps. Then double-check that your subscription is still active. If the credentials look right and it's still not working, re-enter them manually (copy-paste can sometimes add an extra space). Still stuck? Message us on WhatsApp, and we'll sort it out.",
                ],
                [
        ...
        'cta' => [
            ...
            'text' => "Download your app, grab a subscription, and you're good to go. Need help choosing a plan or setting up your device? We're on WhatsApp.",
    ...
    'movies' => [
        ...
        'how_to_watch' => [
            'heading' => 'How to Browse and Watch Movies on Opplex',
            'intro' => "VOD is built into every subscription; there's nothing extra to activate. Once you're logged in to your IPTV app:",
            'steps' => [
            ...
            'support' => "If a title isn't showing up or you want something added, message us on WhatsApp with the name, and we'll look into it.",
        ],
        'devices' => [
            'heading' => 'Watch on Any Screen You Already Own',
            'intro' => "You don't need a new device to access the VOD library. It works on whatever you're already using:",
            'items' => [
                'Amazon Firestick and Fire TV',
                'Samsung, LG, and Sony Smart TVs',
                'Android TV boxes and MAG devices',
                'Android and iOS phones and tablets',
                'Windows PCs and laptops',
                'Mac via IBO Player',
            ],
            'quality' => 'The picture quality adapts to your connection. Most titles stream in Full HD. 4K is available on supported content when your connection is at least 25 Mbps.',
            'apps' => 'See All Compatible Apps',
        ...
        'faq' => [
            ...
            'items' => [
                ...
                [
                    ...
                    'answer' => "Yes. New films and series episodes are added on an ongoing basis. Some titles appear within days of their release on major platforms. If you're looking for something specific and it's not there yet, message us on WhatsApp, and we'll prioritise it.",
                ],
                [
                ...
                [
                    ...
                    'answer' => "Almost always a connection issue or temporary high traffic on that server. Pause for 10 to 15 seconds and then resume; that usually clears it. If it keeps happening on a specific title, let us know on WhatsApp, and we'll check the source.",
                ],
                [
                    'question' => "Can I request a title that isn't in the library?",
                    'answer' => "Yes. Message us on WhatsApp with the movie or series name, and we'll check availability and add it where we can. Most requests are handled within a day or two.",
                ],
                [
                    'question' => 'Is the content the same quality as Netflix or Prime Video?',
                    'answer' => "The source quality varies by title, as on any streaming service. Many titles are in Full HD or 4K. Some older content is in SD. If picture quality matters for a specific film, message us first and we'll confirm what's available.",
                ],
                [
                    'question' => 'Does VOD access cost anything extra?',
                    'answer' => "No. The complete movie and series library is included in every Opplex subscription from day one. There's no VOD add-on, no content tier, and no extra charge; it's all part of the same plan.",
                ],
            ],
        ],
    ],
    ...
    'subscription' => [
        ...
        'hero' => [
            ...
            'paragraphs' => [
                "You're looking for a streaming service that actually works. One that loads channels fast, doesn't buffer at the worst moment, and gives you real support when something goes wrong. That's what Opplex is.",
                'One subscription covers 12,000+ live channels, 50,000+ movies and series, and HD or 4K quality, all streamed over your existing internet connection: no dish, no box rental, no annual contract.',
            ],
        ...
        'included' => [
            'heading' => 'Everything Inside Your Opplex Subscription',
            'intro' => "No tiers. No locked features. Here's what every plan includes from day one:",
            'items' => [
                '12,000+ live channels | UK, USA, sports, international, news, kids',
                '50,000+ movies on demand',
                '5,000+ TV series, current seasons, and classics',
        ...
        'devices' => [
            'heading' => 'Works on the Devices You Already Own',
            'intro' => "You don't need to buy anything to use Opplex. It runs on:",
            'items' => [
                'Amazon Firestick (all generations) and Fire TV',
                'Samsung, LG, and Sony Smart TVs',
                'Android TV boxes and MAG devices',
            ...
            'text' => "The apps are free to download. You only pay for the subscription. If you're not sure which app is right for your device, check the Applications page or message us directly.",
            'cta' => 'See All IPTV Apps',
        ],
        'comparison' => [
    ...
    'shop' => [
        'page_title' => 'Shop',
        'hero' => [
            'eyebrow' => 'Everything you need to get set up and streaming',
            'heading' => 'Streaming Devices, Accessories, and Digital Subscriptions | All in One Place',
            'text' => "The Opplex shop has two things: hardware that makes IPTV streaming better, and digital subscriptions at prices you won't find retail. Affiliate devices link straight to Amazon. Digital products like Netflix, Prime Video, HBO Max, and NordVPN are available at competitive rates. Tap Buy Now and complete your order on WhatsApp.",
            'note' => 'Already have a device and just need Opplex? Head to the Packages page instead.',
            'devices' => 'Browse Devices',
            'digital' => 'View Digital Products',
            'plans' => 'View IPTV Plans',
        ],
        'section_headings' => [
            'devices' => 'Streaming Devices & Accessories',
            'devices_intro' => 'Affiliate devices link directly to Amazon, where purchase, delivery, returns, and refunds are handled.',
            'digital' => 'Digital Subscriptions',
            'digital_intro' => 'Choose a digital subscription and tap Buy Now to complete your order with us on WhatsApp.',
        ],
        ...
        'digital_orders' => [
            'heading' => 'How Digital Product Orders Work',
            'intro' => "Digital subscriptions like Netflix, Prime Video, HBO Max, and NordVPN don't go through standard checkout. Here's how to order:",
            'steps' => [
        ...
        'faq' => [
            ...
            'items' => [
                ...
                ['question' => 'What if a device I ordered from Amazon has an issue?', 'answer' => "Affiliate products are sold through Amazon and covered by their return and refund policies. Any issues with the physical device itself go through Amazon's standard process. For setup help with Opplex on the device, we're here on WhatsApp."],
                ['question' => 'Can you help me pick the right device for my specific TV?', 'answer' => "Yes. Tell us your TV model and what you're trying to set up on WhatsApp, and we'll give you a straight recommendation. No upselling, just whatever actually works best for your situation."],
                ['question' => 'Is it safe to pay for digital products through Opplex?', 'answer' => 'Yes. Payments go through encrypted checkout, and we handle digital product orders on WhatsApp, so you can confirm details before completing. We also accept crypto payments via Cryptomus if you prefer that.'],
            ],
        ],
    ],
];
