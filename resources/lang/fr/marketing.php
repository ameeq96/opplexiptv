...
return [
    'event_promotion' => [
        'whatsapp_click_message' => 'Bonjour, je souhaite profiter de l’offre :event de 10 % sur ma commande Opplex IPTV. L’offre est valable jusqu’au :date.',
        'events' => [
            'new-year' => 'Nouvel An',
    ...
    'social_proof' => [
        'verified_purchase' => 'Achat client',
        'purchased' => ':name a acheté :package.',
        'anonymous_name' => 'Un client',
        'close' => 'Fermer la notification d’achat',
    ],
    'checkout' => [
