...
return [
    'contact_number_notice' => [
        'close_label' => 'Fermer l’avis de changement de coordonnées',
        'eyebrow' => 'Mise à jour importante des coordonnées',
        'title' => 'Notre numéro WhatsApp a changé',
        'body' => 'Tous nos clients, actuels comme nouveaux, doivent désormais nous contacter à ce numéro pour obtenir de l’aide ou poser leurs questions.',
        'whatsapp_message' => 'Bonjour, j’ai une question et j’ai besoin d’aide.',
        'whatsapp_cta' => 'Contactez-nous sur WhatsApp',
        'continue_cta' => 'Continuer vers le site',
    ],
    ...
    'activation' => [
        ...
        'steps' => [
            ...
            'verify_text' => 'L’activation a lieu après confirmation du paiement, pendant les heures d’activité de l’assistance.',
    ...
    'email' => [
        ...
        'checkout' => [
            ...
            'customer_intro' => 'Votre commande est en attente de paiement. Vérifiez les informations ci-dessous, puis poursuivez sur WhatsApp pour recevoir les instructions de paiement.',
            ...
            'expiry' => 'Expiration',
            'notes' => 'Notes',
            'admin_follow_up' => 'Veuillez confirmer le paiement avant de procéder à l’activation.',
            'customer_follow_up' => 'L’activation commence après confirmation du paiement. Si vous avez des questions, répondez simplement à cet e-mail.',
        ],
    ],
