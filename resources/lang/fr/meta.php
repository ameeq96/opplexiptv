...
return [
    ...
    'about' => [
        'title' => 'À propos d’Opplex IPTV - IPTV pro & dev IPTV pro en Europe',
        'description' => 'Opplex IPTV propose des solutions IPTV smart player, Xtream IPTV et IPTV player fiables avec support 24h/24.',
    ...
    'movies' => [
        'title' => 'Regardez 50 000+ films et séries sur IPTV smart player',
        'description' => 'Films récents, Netflix, Prime Video, Bollywood, Hollywood. Compatible avec IPTV stream player, IPTV box, et DAZN IPTV.',
        'keywords' => 'films IPTV, IPTV Netflix, IPTV box, room IPTV, IPTV m3u, DAZN IPTV, IPTV gratuit sans code, IPTV smart player',
    ],
    'packages' => [
    ...
    'iptv-applications' => [
        ...
        'keywords' => 'IPTV Smarters, Xtream IPTV, IPTV stream player, IPTV m3u, IPTV gratuit sans code, meilleure application IPTV, IPTV player iOS Android',
    ],
    'faqs' => [
        'title' => 'FAQ Opplex IPTV - IPTV smart player, box, m3u',
        'description' => 'Réponses aux questions fréquentes : configuration IPTV player, code IPTV, IPTV gratuit sans code, room IPTV, DAZN IPTV, etc.',
    ...
    'redirect.ad' => [
        ...
        'description' => 'Veuillez patienter pendant que nous préparons votre contenu. Obtenez la meilleure configuration IPTV avec Opplex — essai gratuit, opportunités pour',
    ...
    'activate' => [
        'title'       => 'Guide IPTV légal - Streaming sûr, sous licence et conforme',
        'description' => 'Un guide clair pour utiliser l’IPTV légalement : bases des licences, applications/appareils compatibles, notes régionales (UE/R.-U./États-Unis) et',
        'keywords'    => 'IPTV légal, guide IPTV, conformité IPTV, streaming sous licence, IPTV UE, IPTV Royaume-Uni, IPTV États-Unis, droit d’auteur, IPTV sécurisé',
    ],
    'activate-info' => [
        'title'       => 'Infos d’activation – Saisissez votre numéro de commande et démarrez l’IPTV légal',
        'description' => 'Comment activer votre IPTV légalement : saisie du numéro de commande, vérification du compte et démarrage du streaming.',
    ...
    'terms-of-service' => [
        ...
        'description' => 'Lisez les Conditions d’Utilisation d’Opplex IPTV. Découvrez les règles de compte, le paiement, la disponibilité du service et les limitations de',
    ...
    'privacy-policy' => [
        ...
        'description' => 'Notre politique de confidentialité explique la collecte, l’utilisation et la protection de vos données personnelles lors de l’achat d’abonnements IPTV',
    ...
    'shop' => [
        ...
        'description' => 'Découvrez une sélection d’appareils pour le streaming et la TV : Android TV Box, Fire TV Stick 4K Max, Roku Streaming Stick et Ultra, ainsi que supports',
    ...
    'configure' => [
        ...
        'description' => 'Configurez votre commande IPTV en une seule étape : choisissez votre appareil, votre fournisseur IPTV, le nombre de connexions (1, 2 ou 4 appareils) et',
    ...
    'blogs' => [
        'index' => [
            ...
            'description' => 'Découvrez des conseils IPTV, des guides d’installation et les dernières mises à jour d’Opplex IPTV.',
