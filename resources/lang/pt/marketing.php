...
return [
    'event_promotion' => [
        'whatsapp_click_message' => 'Olá, quero usar a oferta de 10% de :event na minha encomenda Opplex IPTV. A oferta é válida até :date.',
        'events' => [
            'new-year' => 'Ano Novo',
            'valentines-day' => 'Dia dos Namorados',
            'mothers-day' => 'Dia da Mãe',
            'fathers-day' => 'Dia do Pai',
            'halloween' => 'Halloween',
    ...
    'social_proof' => [
        'verified_purchase' => 'Compra de cliente',
        'purchased' => ':name comprou :package.',
        'anonymous_name' => 'Um cliente',
        'close' => 'Fechar a notificação de compra',
    ],
    'checkout' => [
