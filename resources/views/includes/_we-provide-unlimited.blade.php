<section class="network-section @unless ($isMobile) @else p-0 @endunless {{ !empty($useSectionSkeletons) ? 'skeleton-section' : '' }}"
                ...
                <div class="content-column col-lg-5 col-md-12 col-sm-12" dir="{{ $isRtl ? 'rtl' : 'ltr' }}">
                    <div class="inner-column" style="text-align: {{ $isRtl ? 'right' : 'left' }}">
                        <div class="sec-title">
                            ...
                            <h1 class="h2" aria-label="IPTV Network Features Heading">
                                {{ __('messages.network_heading') }}</h1>
                            @unless (request()->routeIs('home') || request()->is('/') || request()->routeIs('about') || request()->is('reseller-panel'))
                                <h2 class="h6" aria-label="IPTV Network Features Heading">
                                    {{ __('messages.subheadingiptv') }}
                                </h2>
                            @endunless
                        </div>
