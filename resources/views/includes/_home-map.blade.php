...
<section class="home-map-section py-5" dir="{{ $isRtl ? 'rtl' : 'ltr' }}" aria-labelledby="home-map-heading">
    <div class="auto-container">
        <div class="sec-title mb-4" style="text-align: {{ $isRtl ? 'right' : 'left' }};">
            ...
            <h3 id="home-map-heading" class="h3">{{ __('document_ui.home.map_heading') }}</h3>
            <p class="mb-0">{{ __('document_ui.home.map_text') }}</p>
        </div>
        <div class="home-map-section__embed" role="region" aria-label="{{ __('document_ui.home.map_aria') }}"
            ...
            <iframe
                ...
                title="{{ __('document_ui.home.map_title') }}"
