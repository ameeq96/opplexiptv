                ...
                $platforms = [
                    'android' => [
                        [
                            ...
                            'keywords' => 'latest-IPTV-smarters-pro IPTV-app-download IPTV-APK-Download iptv-Smarters'
                        ],
                        [
                        ...
                        [
                            ...
                            'image' => 'iptv_smarter.webp',
                            'keywords' => 'latest-IPTV-smarters-android IPTV-smarters-android-download IPTV-smarters-mobile IPTV-smarters-LCD IPTV-APK-download IPTV-smarters-for-Android IPTV-smarters-for-TV latest-IPTV-APK IPTV-for-Android-TV iptv-samsung-apk'
                        ],
                        [
                            'version' => 'XTV Live APK',
                            'file' => 'XTVPLAYER3.0.apk',
                            'image' => 'xtv.webp',
                            'keywords' => 'latest-XTV-live-iptv XTV-live-iptv-download XTV-live-iptv-APK XTV-IPTV-app-download XTV-live-APK-download XTV-live-streaming-app XTV-live-TV-APK free-XTV-iptv-APK XTV-iptv-pro-APK latest-XTV-IPTV-app'
                        ]
                    ],
                    'ios' => [
                        [
                            ...
                            'keywords' => 'latest-IPTV-smarters-iOS IPTV-smarters-iOS-download IPTV-iOS-app IPTV-smarters-iOS-APK-download IPTV-smarters-iOS-app-download IPTV-smarters-for-iPhone IPTV-smarters-for-iPad'
                        ]
                    ],
                    'windows' => [
                        [
                            ...
                            'image' => 'iptv_smarter.webp',
                            'keywords' => 'latest-IPTV-smarters-windows IPTV-smarters-windows-download IPTV-smarters-PC IPTV-smarters-laptop IPTV-windows-app-download IPTV-smarters-for-PC IPTV-smarters-for-windows'
                        ]
                    ]
                ];
                @endphp
                ...
                <div class="my-4">
                    @foreach ($platforms as $platform => $apps)
                        <div class="{{ $platform }} mb-5">
                            ...
                            @foreach ($apps as $app)
                                <a target="_blank" href="downloads/{{ $app['file'] }}" class="btn btn-light" keywords="{{ $app['keywords'] }}" download>
                                    <img width="40px" src="images/{{ $app['image'] }}" alt="icon"> Download {{ $app['version'] }}
                                </a>
                            @endforeach
                        </div>
                    @endforeach
