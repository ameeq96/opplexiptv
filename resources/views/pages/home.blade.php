    ...
    <script id="home-native-shell">
        (function () {
            ...
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initHomeNativeShell, { once: true });
            } else {
                initHomeNativeShell();
            }
        })();
