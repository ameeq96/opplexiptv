...
@if ($usesDocumentLayout)
    @push('styles')
        ...
        @endphp
        @if ($packagesDocumentCss !== false)
            <style id="packages-document-styles">{!! $packagesDocumentCss !!}</style>
        @else
            <link rel="stylesheet" href="{{ asset('css/document-commerce.css') }}">
        @endif
    @endpush
@endif
...
@section('script')
    <script id="packages-native-shell">
        (function () {
            'use strict';
            ...
            function initPackagesMobileMenu() {
            ...
            function initPackagesDropdowns() {
            ...
            function initPackagesNativeShell() {
                initPackagesScrollUi();
                initPackagesMobileMenu();
                initPackagesDropdowns();
                initPackagesFaqs();
            }

            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initPackagesNativeShell, { once: true });
            } else {
                initPackagesNativeShell();
            }
        })();
    </script>
@endsection
