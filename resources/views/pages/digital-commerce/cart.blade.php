                ...
                <div class="row g-4">
                        ...
                        @foreach($items as $item)
                            <article class="dcart-item"
                                ...
                                <div class="dcart-actions">
                                    ...
                                    <a href="https://wa.me/{{ config('services.whatsapp.number') }}?text={{ rawurlencode('Hi, I want to buy ' . $item['product']->title . ' (' . ($item['product']->currency ?: '$') . number_format((float) $item['product']->price, 2) . ').') }}"
                                       target="_blank"
                    ...
                    <div class="col-lg-4">
                        <aside class="dcart-summary">
                            ...
                            <a href="https://wa.me/{{ config('services.whatsapp.number') }}?text={{ rawurlencode('Hi, I want to place my digital products order.') }}"
                               target="_blank"
                               rel="noopener noreferrer"
